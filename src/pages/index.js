...
import { cantoNFT, cantoCustody, cantoErc20, cantorpc } from './engine/configuration'
...
export default function Home() {
  ...
  const blockImage = React.useMemo((resolve, reject) => {
    ...
    } else if (destChain == canto) {
      return <img src="canto.jpeg" width={"160px"} />;
    }
  });
      ...
      return (
        <div>
          <Row css={{ marginTop: "$1" }}>
            ...
            <img src="canto.jpeg" width={"190px"} />
          </Row>
          <Row>
            <Text css={{ marginTop: "$6", marginRight: "$2" }} h4>
              NFT ID:
  ...
  const sourceImg = React.useMemo((resolve, reject) => {
    ...
    } else if (sourceRpc == cantorpc) {
      return (
        <div>
          <Row>
            <Col>
            <Text h4>Bridge Source</Text>
             <img src="canto.jpeg" width={"210px"} />
             </Col>
            <Col css={{marginTop:'$12', paddingLeft:'$12'}}>
            <div style={{marginTop:'5px'}} id="arrowAnim">
              <div className="arrowSliding">
...
async function initTransfer() {
  ...
  var eth = "Ethereum";
  if (canto == destChain) {
    var dCustody = cantoCustody;
    var dRpc = cantorpc;
    var explorer = "explorer url";
    var dNFT = cantoNFT;
